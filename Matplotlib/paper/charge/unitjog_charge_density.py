...
'''
cb.set_ticks(np.linspace(-0.02,0.02,5,endpoint=True))
...
plt.plot(dipole[::2,0]/bmag-0.65, dipole[::2,1]/alat,linewidth='5.0', color='black') 
plt.plot(dipole[1::2,0]/bmag+0.65, dipole[1::2,1]/alat, linewidth='5.0',color='black')
...
plt.savefig("unitjog_chargeDensity.pdf", bbox_inches="tight")
plt.show()